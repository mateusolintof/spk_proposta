...
const flowDataByAgent: Record<AgentType, { nodes: Node[]; edges: Edge[] }> = {
  atendimento: {
    nodes: [
      ...
      { id: "2", type: "custom", position: { x: 200, y: 100 }, data: { label: "Agente Atendimento", description: "Distribui por carga", icon: "Headphones", variant: "primary" } },
      ...
      { id: "4", type: "custom", position: { x: 400, y: 200 }, data: { label: "Qualificação", description: "Coleta dados 24/7", icon: "Bot", variant: "primary" } },
      ...
      { id: "7", type: "custom", position: { x: 800, y: 0 }, data: { label: "Monitora tempo", description: "Resposta rápida", icon: "Clock", variant: "decision" } },
